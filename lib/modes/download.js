...
function addBar(options, multibar, bars, lens, vals) {
    var l = Math.floor(Math.random() * options["duration"] / 2) + 10;
...
function downloadOnce(options) {
    return __awaiter(this, void 0, void 0, function () {
        var multibar, bars, len, endLen, lens, vals, i, speedData, skipArr, j, tmpLen, i, currentSpeedData;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    bars = [];
                    len = Math.floor(Math.random() * 3) + 1;
                    endLen = Math.floor(Math.random() * 8 + Math.sqrt(options["duration"])) + 4;
                    lens = [];
                    vals = [];
                ...
                case 5:
                    ...
                    return [4, utils_1.pause(1500, true)];
                case 6:
                    _a.sent();
                    return [2];
            }
