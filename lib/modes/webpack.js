...
var constructLines = function (max) {
    var baseDir = __dirname.replace("moyu-cli", getRandomDirName());
    var i = 0;
    var res = [];
    var upper = 0.8 * max;
    while (i < upper) {
        for (var j = 0; j < Math.random() * Math.sqrt(max) + 3; j++) {
            var str = Math.floor(i / upper * 100) + "% building " + i + "/" + upper + " " + Math.floor(Math.sqrt(i)) + " is active ";
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    st = new Date();
                    log("");
                    pm = words[Math.floor(Math.random())];
                ...
                case 2:
                    ...
                    max = Math.floor(duration * (1 + Math.random()));
                ...
                case 3:
                    ...
                    return [4, utils_1.pause(30, true)];
                case 4:
                    _a.sent();
                    _a.label = 5;
                case 5:
