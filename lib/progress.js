...
function oneBar(duration) {
    return new Promise(function (resolve, reject) {
        var b1 = new cliProgress.SingleBar({}, cliProgress.Presets.shades_classic);
        b1.start(100, 0, {});
        var i = 0;
        function _() {
            b1.increment();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    if (!true) return [3, 7];
                    if (!(repeat == i)) return [3, 2];
                    return [3, 7];
                case 2:
                    if (!(repeat == 1)) return [3, 4];
                    return [4, oneBar(duration)];
                case 3:
                    _a.sent();
                    return [3, 6];
                case 4:
